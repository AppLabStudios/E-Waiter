                    ...
                    ScrollView {
                        VStack(spacing: 24) {
                            ...
                            LazyVGrid(columns: [
                                ...
                                StatCard(title: "Pending Orders", value: "0", icon: "clock", color: .orange)
                                StatCard(title: "Active Tables", value: "0", icon: "table.furniture", color: .green)
                                StatCard(title: "Today's Sales", value: "$1,250", icon: "chart.line.uptrend.xyaxis", color: .purple)
                                StatCard(title: "Orders Served", value: "0", icon: "checkmark.circle", color: .blue)
                            }
                            
                            // Action Buttons
                            VStack(spacing: 16) {
                                ActionButton(title: "View Orders", icon: "list.bullet", action: {})
                                ActionButton(title: "Table Status", icon: "table.furniture", action: {})
                                ActionButton(title: "Menu Items", icon: "fork.knife", action: {})
...
#Preview {
    StaffView(restaurantId: "preview", deviceId: "device1")
} 